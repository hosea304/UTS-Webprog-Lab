...
if (isset($_POST['submit'])) {
  ...
  $sqlEdit = "UPDATE tbl_tugas SET tugas ='" . $tugas . "', priority = '" . $priority . "', status = '" . $status . "', deskripsi = '" . $deskripsi . "', tanggal = '" . $tanggal . "' WHERE id = " . $id;
...
<body>
  <div class="container-fluid">
    <div class='d-flex justify-content-center align-items-center w-100 h-100 flex-column'>
      ...
      <form action="edit.php" method='POST' class="mb-3 task-box">
